...
HF_HUB_ENABLE_HF_TRANSFER=1 huggingface-cli download black-forest-labs/FLUX.1-Fill-dev flux1-fill-dev.safetensors model_index.json --local-dir .
mv flux1-fill-dev.safetensors flux1_fill_dev.safetensors
echo "saved: flux1_fill_dev.safetensors"
chmod +x flux1_fill_dev.safetensors
