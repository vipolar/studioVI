...
# Getting CUDA 12.4 tookit (libtinfo5 added manually) from the official nvidia repository for ubuntu 22.04 LTS
...
# Getting CUDNN 8.9.7.29 from the official nvidia archives: https://developer.download.nvidia.com/compute/cudnn/redist/cudnn/linux-x86_64/
